...
public class RelatedArticleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public OnLoadMoreRelatedListener loadMoreListener;
    boolean isLoading = false, isMoreDataAvailable = true;

    public RelatedArticleAdapter(Context context, List<Object> list){
...
//        }
    ...
    public interface OnLoadMoreRelatedListener{
        void onLoadMore();
    }

    public void setLoadMoreListener(OnLoadMoreRelatedListener loadMoreListener){
