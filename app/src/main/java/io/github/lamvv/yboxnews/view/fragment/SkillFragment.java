...
public class SkillFragment extends Fragment implements ObservableScrollViewCallbacks {
...
//    private RecyclerView mRecyclerView;
    ...
    public static SkillFragment newInstance(String text) {
        SkillFragment mFragment = new SkillFragment();
...
//						int index = articles.size() - 1;
    ...
    private void load(int page){
        Call<ArticleList> call = api.getSkillArticle(page);
