...
public class ScholarshipFragment extends Fragment implements ObservableScrollViewCallbacks {
...
//        actionBar.setSubtitle("Ybox " + mContext.getResources().getString(R.string.scholarship));
