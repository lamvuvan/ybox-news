...
public class RecruitmentFragment extends Fragment implements ObservableScrollViewCallbacks {
...
//    private RecyclerView mRecyclerView;
    ...
    public static RecruitmentFragment newInstance(String text) {
        RecruitmentFragment mFragment = new RecruitmentFragment();
...
//        actionBar.setSubtitle("Ybox " + mContext.getResources().getString(R.string.recruitment));
...
//						int index = articles.size() - 1;
    ...
    private void load(int page){
        Call<ArticleList> call = api.getRecruitmentArticle(page);
